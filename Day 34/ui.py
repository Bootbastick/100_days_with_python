...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.true_button = Button(image=self.true_button_img, command=self.user_ans_true)
        self.true_button.grid(row=2, column=0)

        self.false_button_image = PhotoImage(file="images/false.png")
        self.false_button = Button(image=self.false_button_image, command=self.user_ans_false)
